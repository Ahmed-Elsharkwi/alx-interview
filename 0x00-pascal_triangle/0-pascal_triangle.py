...
def pascal_triangle(n):
    """
    calculate the pascal triangle by calculating the sum of two pervious variable to get the value
        ...
        for row in range(0, n):
            ...
            if row != 0:
                ...
                for j in range(1, row):
                    internal_list.append(main_list[row-1][j-1] + main_list[row-1][j])
